...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#2cafff", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#fdc947", textDisabled: "#BDC2C4", textSubtle: "#ffffff", borderColor: "#E9EAEB", card: "#009EFF", gradients: {
