...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#2cafff", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#009eff", input: "#eeeaf4", tertiary: "#3eb6ff", text: "#fdc947", textDisabled: "#BDC2C4", textSubtle: "#ffffff", borderColor: "#E9EAEB", card: "#009EFF", gradients: {
