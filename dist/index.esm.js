...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#2cafff", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#009eff", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#452A7A", textDisabled: "#BDC2C4", textSubtle: "#8f80ba", borderColor: "#E9EAEB", card: "#009EFF", gradients: {
